...
import re
from web_crawler import cookpad,dailycook,icook,kitchen_story
...
def generate_data(keyword,number):
    ...
    kitchen_story_data  = get_kitchen_story(number,' '.join(keyword))
    ...
    #讀取楊桃資料庫
    yuntow = pd.read_excel("recipe_database.xlsx")
